...
import com.qi.realtime.monitor.entity.TestCaseEvent;
...
public class QualityDashboardKafka {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 统计10秒内的通过率
//        events.keyBy(com.qi.realtime.monitor.entity.TestCaseEvent::getModule)
//                .window(TumblingEventTimeWindows.of(Time.seconds(10)))
//                .process(new ProcessWindowFunction<com.qi.realtime.monitor.entity.TestCaseEvent, String, String, TimeWindow>() {
//                    @Override
//                    public void process(String module, ProcessWindowFunction<com.qi.realtime.monitor.entity.TestCaseEvent, String, String, TimeWindow>.Context context, Iterable<com.qi.realtime.monitor.entity.TestCaseEvent> elements, Collector<String> out) throws Exception {
//                        int suc = 0;
//                        int total = 0;
//
//                        for (com.qi.realtime.monitor.entity.TestCaseEvent e : elements) {
...
//                .print("agg方式");
  ...
  public static class PassRateAggregate implements AggregateFunction<com.qi.realtime.monitor.entity.TestCaseEvent, Tuple3<String, Integer, Integer>, Tuple3<String, Integer, Integer>> {
        ...
        @Override
        public Tuple3<String, Integer, Integer> add(com.qi.realtime.monitor.entity.TestCaseEvent value, Tuple3<String, Integer, Integer> accumulator) {
    ...
    public static class ConsecutiveFailAlertFunction extends KeyedProcessFunction<String, com.qi.realtime.monitor.entity.TestCaseEvent, TestCaseEvent> {
        ...
        @Override
        public void processElement(com.qi.realtime.monitor.entity.TestCaseEvent event, Context ctx, Collector<TestCaseEvent> out) throws Exception {
            ...
            if ("FAIL".equalsIgnoreCase(status)) {
                ...
                if (count >= THRESHOLD && (now - lastAlert > COOLDOWN_MS)) {
                    ctx.output(ALERT_TAG, new com.qi.realtime.monitor.entity.AlertEvent(
