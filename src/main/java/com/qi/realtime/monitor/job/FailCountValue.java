...
public class FailCountValue extends KeyedProcessFunction<String, TestCaseEvent, com.qi.realtime.monitor.entity.TestCaseEvent> {


    OutputTag<com.qi.realtime.monitor.entity.AlertEvent> ALART_TAG = new OutputTag<>("alart_tag") {
    };
    ...
    @Override
    public void processElement(com.qi.realtime.monitor.entity.TestCaseEvent event, KeyedProcessFunction<String, TestCaseEvent, com.qi.realtime.monitor.entity.TestCaseEvent>.Context ctx, Collector<TestCaseEvent> out) throws Exception {
