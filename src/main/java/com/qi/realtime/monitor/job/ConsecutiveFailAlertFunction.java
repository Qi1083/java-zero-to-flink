...
@Slf4j
public class ConsecutiveFailAlertFunction extends KeyedProcessFunction<String, TestCaseEvent, com.qi.realtime.monitor.entity.TestCaseEvent> {
    ...
    @Override
    public void processElement(TestCaseEvent event, KeyedProcessFunction<String, TestCaseEvent, com.qi.realtime.monitor.entity.TestCaseEvent>.Context ctx, Collector<TestCaseEvent> out) throws Exception {
