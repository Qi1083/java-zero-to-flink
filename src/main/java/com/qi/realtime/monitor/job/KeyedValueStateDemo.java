...
public class KeyedValueStateDemo {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WaterSensor> sensorDS = env.socketTextStream("localhost", 8090).map(new WaterSensorMapFunction())
                .assignTimestampsAndWatermarks(WatermarkStrategy.<com.qi.realtime.monitor.entity.WaterSensor>forBoundedOutOfOrderness(Duration.ofSeconds(3)).
        ...
        sensorDS.keyBy(key -> key.getId()).process(new KeyedProcessFunction<String, WaterSensor, String>() {
            ...
            @Override
            public void processElement(WaterSensor value, KeyedProcessFunction<String, com.qi.realtime.monitor.entity.WaterSensor, String>.Context ctx, Collector<String> out) throws Exception {
                // 取出上一个水位值
