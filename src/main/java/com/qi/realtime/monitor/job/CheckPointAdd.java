...
import com.qi.realtime.monitor.entity.WaterSensor;
...
public class CheckPointAdd {
    public static void main(String[] args) throws Exception {
        ...
        // 3. KeyBy + 窗口 + 绑定窗口计算函数
        sensorDS.keyBy(com.qi.realtime.monitor.entity.WaterSensor::getId)
    ...
    // 内置连续源（同上，保持事件时间推进）
    public static class ContinuousSensorSource implements SourceFunction<com.qi.realtime.monitor.entity.WaterSensor> {
        ...
        public void run(SourceContext<com.qi.realtime.monitor.entity.WaterSensor> ctx) throws Exception {
            ...
            while (isRunning) {
                ctx.collect(new com.qi.realtime.monitor.entity.WaterSensor("sensor_" + (rand.nextInt(2) + 1), currentTs, 20 + rand.nextInt(30)));
